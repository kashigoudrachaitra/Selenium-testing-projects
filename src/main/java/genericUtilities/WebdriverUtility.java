...
public class WebdriverUtility {
	public void waitForPageToLoad(WebDriver driver) {
		...
		public void waitForVisibilityOfElement(WebDriver driver, 
		WebElement element) {
		...
		public void switchToFrame(WebDriver driver, WebElement 
		frameElement) {
		...
		public void switchToAlertAndSendkeys(WebDriver driver, String 
		text) {
		...
		public void clickOnWebElement(WebDriver driver, WebElement 
		element) {
		Actions act = new Actions(driver);
		...
		public void rightClickOnWebElement(WebDriver driver, 
		WebElement element) {
		Actions act = new Actions(driver);
		act.contextClick(element).perform();
		}
		public void passInput(WebDriver driver, WebElement element, 
		String text) {
		Actions act = new Actions(driver);
